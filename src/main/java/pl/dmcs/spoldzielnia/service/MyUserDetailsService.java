...
public class MyUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(final String login) throws UsernameNotFoundException {
		...
		pl.dmcs.spoldzielnia.domain.User user = userDAO.findByLogin(login);
	...
	private User buildUserForAuthentication(pl.dmcs.spoldzielnia.domain.User user, List<GrantedAuthority> authorities) {
