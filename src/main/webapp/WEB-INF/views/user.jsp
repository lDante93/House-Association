...
<body>
	...
	<div class="thumbnail">
		...
		<div class="caption">
			<form:form method="post" action="addUsers.html" commandName="user">
				<table>
					<tr>
				...
				<table class="data">
					...
					<c:forEach items="${userList}" var="user" varStatus="status">
						...
						<c:if test="${!status.first}"><tr>
							...
							<td width="120"><h5>${user.firstname}</h5></td>
							<td width="120"><h5>${user.lastname}</h5></td>
							<td width="150"><h5>${user.email}</h5></td>
							<td width="120"><h5>${user.telephone}</h5></td>
							<td width="120"><h5>${user.amountOfLocators}</h5></td>
							<td width="120"><h5>${user.apartment.building.street}</h5></td>
							...
							<td><div class="col-lg-offset-1 col-lg-10">
									<a href="delete/users/${user.id}.html" class="btn btn-danger">Usuń</a>
								</div></td>
							<td><div class="col-lg-offset-1 col-lg-10"><a href="users.html?userId=${user.id}"
								class="btn btn-warning">Edytuj</a>	</div></td>
								<td><div class="col-lg-offset-1 col-lg-10"><a href="userEditPassword.html?userId=${user.id}&buildingId=${user.apartment.building.id}&apartmentId=${user.apartment.id}"
								class="btn btn-info">Zmień Hasło</a></div></td>
							</tr>
						</c:if>
					</c:forEach>
				</table>
